 ...
 * @author Hady Ahmed
 */
public class Show_All_Reders extends javax.swing.JFrame {
int i=0;
public void show_r(String first_name,String last_name,String Id,String address,String phone,String email)
{
    ...
    /**
     * Creates new form Show_All_Readers
     */
    ...
    private void initComponents() {
        ...
        jTextField3.setToolTipText("the user name is uneditable");
        ...
        jButton19.setToolTipText("To display Next User");
        ...
        jButton17.setText("Block That User");
        jButton17.setToolTipText("Block That User");
        ...
        jButton18.setToolTipText("To display Previous User");
        ...
        jPanel3.add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 290, 200, 30));
        ...
        jPanel3.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 190, 240, 30));
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        {
        i++;
        cont.show_reders.show_r(Home.readers[i].First_Name,Home.readers[i].Last_Name, String.valueOf(Home.readers[i].ID), Home.readers[i].Address, String.valueOf(Home.readers[i].Cellphone), Home.readers[i].Email);
        }
