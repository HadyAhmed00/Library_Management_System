...
int user_id;
       String book_name;
    /**
     * Creates new form Add_User_to_list
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_User_to_list.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               // new Add_User_to_list().setVisible(true);
