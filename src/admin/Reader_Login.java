 ...
 * @author User
 */
public class Reader_Login extends javax.swing.JFrame {
int id;
String pass;
    /**
     * Creates new form Reader_Login
     */
    public Reader_Login() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reader_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reader_Login().setVisible(true);
            }
        });
    }
